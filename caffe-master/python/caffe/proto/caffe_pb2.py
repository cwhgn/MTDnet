...
_TRIPLETLOSSPARAMETER = descriptor.Descriptor(
...
class TripletLossParameter(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
