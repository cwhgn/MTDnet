...
if __name__ == '__main__':
    ...
    #the Valdata_list_VIPeR.npy if used our recorded val data
    valdir ='.../BuildData'
    #Relative image path of VIPeR
    t_indir = 'VIPeRData/image'
    #Relative image path of cuhk03
    s_indir = 'cuhk03Data/image' 
    #The public path where VIPeRData and cuhk03Data are saved.
    pb_indir = '.../BuildData' 
    ...
    val_data = np.load(r'%s/RecordedValdata_VIPeR.npy' %(valdir)) 
