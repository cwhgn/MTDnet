...
def BuildCUHK03TripleFile(indir,name,ids):
    ...
    eachlet = 4#int(total_samples/(2*pairs))+1;
...
if __name__ == '__main__':
    ...
    #the Valdata_list_CUHK01half.npy if used our recorded val data
    valdir ='.../BuildData'
    #Relative image path of CUHK01half
    t_indir = 'CUHK01halfData/image'
    #Relative image path of cuhk03
    s_indir = 'cuhk03Data/image' 
    #The public path where CUHK01halfData and cuhk03Data are saved.
    pb_indir = '.../BuildData' 
    ...
    val_data = np.load(r'%s/RecordedValdata_CUHK01half.npy' %(valdir))
