...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle=false \
    $TRAIN_DATA_ROOT \
    $DATA/XX_trainaug_pos1.txt \
    $EXAMPLE/XX_trainaug_lmdb_pos1
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle=false \
    $TRAIN_DATA_ROOT \
    $DATA/XX_trainaug_pos2.txt \
    $EXAMPLE/XX_trainaug_lmdb_pos2
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle=false \
    $TRAIN_DATA_ROOT \
    $DATA/XX_trainaug_neg.txt \
    $EXAMPLE/XX_trainaug_lmdb_neg
